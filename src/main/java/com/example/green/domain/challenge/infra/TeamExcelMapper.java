...
public class TeamExcelMapper implements ExcelDataMapper<AdminTeamChallengesDto> {
	...
	@Override
	public Class<AdminTeamChallengesDto> getDataType() {
		return AdminTeamChallengesDto.class;
	}
	...
	public List<ExcelField> getFields() {
		...
		return List.of(
			...
			ExcelField.of("팀 수", headerColor, FieldFormat.NUMBER),
	...
	@Override
	public Object[] extractRowData(AdminTeamChallengesDto data) {
		return new Object[] {
			data.challengeCode(),
			data.challengeName(),
			data.getPeriod(),
