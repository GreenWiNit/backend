...
//
// 		// 그룹 주소 생성
// 		GroupAddress groupAddress = GroupAddress.of(dto.roadAddress(), dto.detailAddress(), dto.sigungu());
//
// 		// 팀 코드 생성
...
//
// 		// 그룹 주소 생성
// 		GroupAddress groupAddress = GroupAddress.of(request.roadAddress(), request.detailAddress(), request.sigungu());
//
// 		// 그룹 정보 수정
// 		group.update(
// 			request.groupName(),
