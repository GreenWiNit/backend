...
public interface AdminTeamChallengeQueryControllerDocs {
	...
	@Operation(summary = "팀 챌린지 목록 조회 (ad_B01_004), 팀 챌린지 목록", description = "팀 챌린지 목록을 조회합니다. (10개씩 조회)")
	@ApiErrorStandard
	...
	@Operation(summary = "팀 챌린지 목록 엑셀 다운로드 (ad_B01_004), 팀 챌린지 목록", description = "팀 챌린지 목록 엑셀 다운로드")
	@ApiErrorStandard
	...
	@Operation(summary = "팀 챌린지 상세 조회 (ad_B01_005), 기본 정보", description = "팀 챌린지 상세 정보를 조회합니다.")
	@ApiErrorStandard
