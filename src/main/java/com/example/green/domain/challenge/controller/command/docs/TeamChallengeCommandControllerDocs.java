...
public interface ChallengeControllerDocs {
	...
	NoContent joinTeamChallenge(
		@Parameter(name = "chlgNo", description = "참여할 팀 챌린지 ID", in = PATH, required = true, example = "1")
	...
	NoContent joinPersonalChallenge(
		@Parameter(name = "chlgNo", description = "참여할 개인 챌린지 ID", in = PATH, required = true, example = "1")
		Long challengeId, PrincipalDetails currentUser
	);

	@Deprecated
	NoContent leaveChallenge(Long chlgNo);
	...
	NoContent leavePersonalChallenge(
		@Parameter(name = "chlgNo", description = "탈퇴할 챌린지 ID", in = PATH, required = true, example = "1")
		Long challengeId, PrincipalDetails currentUser
	);
