...
public record ChallengeGroupDto(
	...
	public ChallengeGroupDto(
		Long id, String groupName, String sigungu, GroupPeriod period, GroupCapacity capacity, Boolean isLeader
	) {
		this(
			id, groupName, sigungu, period.getBeginDateTime(), period.getEndDateTime(),
			capacity.getCurrentParticipants(), capacity.getMaxParticipants(), isLeader
		);
	}
}
