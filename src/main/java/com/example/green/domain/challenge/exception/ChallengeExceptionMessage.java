...
public enum ChallengeExceptionMessage implements ExceptionMessage {
	...
	CHALLENGE_BEGIN_DATE_NULL("챌린시 시작일은 필수 입니다.", BAD_REQUEST),
	CHALLENGE_END_DATE_NULL("챌린시 종료일은 필수 입니다.", BAD_REQUEST),
	INVALID_MINIMUM_POINT("챌린지의 지급 포인트는 0원 이상이어야 합니다.", BAD_REQUEST),
	CHALLENGE_CONTENT_EMPTY("챌린지 내용은 필수입니다.", BAD_REQUEST),
	INVALID_CHALLENGE_IMAGE("유요하지 않은 이미지 형식입니다.", BAD_REQUEST),
	CHALLENGE_NAME_EMPTY("챌린지명은 필수 정보입니다.", BAD_REQUEST),
	CHALLENGE_POINT_EMPTY("챌린지 지급 포인트는 필수 정보입니다.", BAD_REQUEST),
	...
	public static final String CHALLENGE_CODE_NON_NULL = "챌린지 코드 정보가 누락되었습니다.";
