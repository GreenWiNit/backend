...
public class ChallengeCertificationService {
	...
	private ChallengeCertificationCreateResponseDto createPersonalChallengeCertification(
		...
		// 중복 인증 확인 (하루 한 번 제약)
		if (personalChallengeCertificationRepository.existsByParticipationAndCertifiedDate(participation, certifiedDate)) {
		...
		// 인증 저장
		PersonalChallengeCertification savedCertification = personalChallengeCertificationRepository.save(certification);
